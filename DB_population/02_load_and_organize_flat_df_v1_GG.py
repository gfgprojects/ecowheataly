#exec(open("02_load_and_organize_flat_df_v1_GG.py").read())
"""
...
## ===================== FILTERING ===========================
from flat_utils  import remove_outliers_adjusted_boxplot
import gc
...
for c in cols[1:4]:
    ...
    flat_df.loc[zero_rows,2::] = np.nan
...
log3_rec.to_latex("1_DB_population/tabella_output.tex", index=False, encoding='utf-8')
