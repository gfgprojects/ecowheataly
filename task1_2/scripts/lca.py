...
# Step 2: Create the EcoWheataly production activity
db_name = "ecowheataly"
...
fito_fluxes_code = [
    ('a805071f-ce96-4d72-bdd5-4334d9aa3c23', Fungicide_harmful),
    ('3850d44e-8919-47bc-9c0a-51ccc4ec9d9f', Herbicide_caution),
    ('41a4e1fe-34ee-54d9-b049-3a60ada1ae3e', Herbicide_irritating),
    ('e5492922-eaf5-4409-aa49-7f2a35cd0336', Herbicide_harmful),
    ('51c7daf4-14e1-45e9-aa67-051c4ddcd9da', GrowthRegulator_harmful),
    ('282973e4-3c2d-4a9c-a3f2-d39a5b36aa76', Insecticide_harmful),
    ('1c0699e2-9be2-4c30-8328-fc0ad8caac58', Insecticide_toxic),
    ('597847df-518f-4bd6-ae50-1de01f2761a4', Molluscicide_irritating)
]
