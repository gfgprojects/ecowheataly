...
for code in farm_codes:
 ...
 datastore[str(code)]={"count_in_farms_file(years)": int(tmp_df.shape[0]),"regione":tmp_df.loc[0,"Regione"],"geo":tmp_df.loc[0,"Provincia"],"zona altimetrica 5":tmp_df.loc[0,"Zona_Altimetrica_5"],"zona altimetrica 3":tmp_df.loc[0,"Zona_Altimetrica_3"]}
